    ...
    <table class="styled-table" id= "table_id">
      ...
      <tbody id="tbody_table_record">
        <?php
          ...
          $num = 0;
          //---------Hien thin bang luu du lieu tu DHT11 
          $pdo = Database::connect();
          // Tai dong :  $sql = 'SELECT * FROM esp32_table_dht11_record ORDER BY date, time';  ban co the thay doi ten table giong voi ten table ban tao de luu du lieu
	
		  
          $sql = 'SELECT * FROM esp32_table_dht11_record ORDER BY date, time';
